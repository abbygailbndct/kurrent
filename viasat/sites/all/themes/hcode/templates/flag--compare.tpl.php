...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if($flag_short_display) : ?>
    <?php if ($link_href): ?>
      <a href="<?php print $link_href; ?>" class="highlight-button-dark btn btn-small no-margin-right quick-buy-btn <?php print $flag_classes; ?>" title="<?php print $link_text; ?>"><i class="fa fa-refresh"></i></a>
    <?php else: ?>
      <a href="#" class="highlight-button-dark btn btn-small no-margin-right quick-buy-btn <?php print $flag_classes; ?>" title="<?php print $link_text; ?>"><i class="fa fa-refresh"></i></a>
    <?php endif; ?>
  <?php else: ?>
    <?php if ($link_href): ?>
