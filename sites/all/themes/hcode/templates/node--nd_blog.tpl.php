...
$bg_image = _get_node_field($node, 'field_background_image');
if(empty($bg_image)) {
  $bg_image = _get_node_field($node, 'field_image');
}
$bg_path = empty($bg_image) ? '' : file_create_url($bg_image[0]['uri']);

?>

<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>

  <section class="wow fadeIn blog-single-full-width-header fix-background parallax-fix mb120">
      <img class="parallax-background-img" src="<?php print $bg_path; ?>" alt="" />
      <div class="opacity-medium bg-black"></div>
      <div class="container">
          <div class="row">
              <div class="col-md-7 col-sm-8 position-relative full-width-headline text-center center-col">
                  <!-- post title  -->
                  <h2 class="white-text"><span><?php print $title; ?></h2>
                  <!-- end post title  -->
                  <!-- post date and categories  -->
                  <?php if($display_submitted): ?>
                    <div class="posted-by text-uppercase"><?php print t('Posted by');?> <?php print $name; ?></div>
                  <?php endif; ?>
                  <div class="blog-date"><?php print date('d ', $node->created) . date('F ', $node->created) . date('Y', $node->created); ?> | <?php print render($content['field_category']); ?></div>
